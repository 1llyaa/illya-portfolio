...
export class MyTechStackComponent {
    skills: Skill[] = [
        {
            tooltip:
                'Building modern web applications with Angular. Experience with TypeScript, RxJS, and Angular Material.',
        ...
        {
            tooltip:
                'Backend development, automation, scraping and APIs using Python. Experience with FastAPI and Django.',
